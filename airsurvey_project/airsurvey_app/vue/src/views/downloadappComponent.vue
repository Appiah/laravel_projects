<template>
<div class="bg-cover bg-center absolute z-0 h-screen bg-no-repeat" style="background-image:url('http://preview.uxtheme.website/xpider-preview/xpider/img/hero-8.png')"></div>
    ...
    <div class="absolute w-full flex flex-col">
            ...
            <header class="z-20 w-full xl:px-0 px-2">
                <div class="container mx-auto flex flex-wrap mt-8 mb-8 ">
                    <div class="flex sm:w-1/2 flex">
                        ...
                        <a href="/" class="text-2xl text-white ml-1 font-bold">airsurvey</a>
                    </div>
                    <div class="w-1/2 hidden sm:flex justify-end">
                        <button class="border border-white bg-transparent text-white uppercase rounded-full py-2 px-4 hover:bg-blue-600">Download Now</button>
                    </div>
                </div>
            </header>
            <section class="w-full">
                <div class="container mx-auto flex flex-row sm:items-center xl:pb-16 xl:px-0 px-4">
                    <div class="w-1/2 text-white flex flex-col">
                        <h1 class="sm:text-5xl text-xl font-weight-bolder sm:mb-4">connect to people, products and services<p>you care about even if</p><p>there is no internet.</p></h1>
                        <h2 class="sm:text-2xl text-base mb-2">conceive | believe | achieve.</h2>
                        <p class="text-xs sm:text-base">Endless possibilities.</p>
                        <form class="xl:mt-4 mt-8 flex hidden xl:flex">
                            <input class="rounded-l-full p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white" placeholder="your@email.com"/>
                            <button class="px-8 rounded-r-full bg-yellow-400  text-gray-800 font-bold p-4 uppercase border-yellow-500 border-t border-b border-r">Send download link</button>
                        </form>
                        <p class="text-xs sm:block hidden">* Free for personal use</p>
                    </div>
                    <div class="w-1/2 xl:pt-8 xl:items-center flex justify-end">
                        <img class="xl:w-3/5" src="https://preview.uxtheme.website/xpider-preview/xpider/img/mobile-4.png" alt="Mobile phone"/>
                    </div>
                </div>
            </section>
        </div>
        <div class="bg-white pb-8 w-full pt-8">
            <div class="container mx-auto">
                <form class="flex xl:hidden p-2 w-full justify-center pb-16">
                    <input class="rounded-l-full p-2 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white" placeholder="your@email.com"/>
                    <button class="px-2 rounded-r-full bg-yellow-400 text-gray-800 font-bold p-4 uppercase border-yellow-500 border-t border-b border-r">Send download link</button>
                </form>
                <div class="text-center w-full pb-16">
                    <h3 class="uppercase text-gray-800">Why choose aireceive?</h3>
                    <p class="sm:text-3xl text-2xl text-black-800 pt-4 xl:w-1/2 mx-auto">
                        A simple, safe, secured and reliable way to remain connected.
                    </p>
                </div>
        ...
        <center>
            <footer class="container text-center pb-8 border-t border-gray-200 pt-8 text-xs text-gray-700">
                <div>a product of <a class="text-orange-600" href="https://www.aireceive.com">aireceive</a> LLC</div>
            </footer>
        </center>
    </div>
</template>